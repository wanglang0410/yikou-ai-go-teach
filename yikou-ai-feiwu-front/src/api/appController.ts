...
export async function deployAppCancel(
  body: API.AppDeployCancelDto,
  options?: { [key: string]: any }
) {
...
export async function listGoodAppVoByPage(body: API.AppQueryDto, options?: { [key: string]: any }) {
...
export async function listMyAppVoByPage(body: API.AppQueryDto, options?: { [key: string]: any }) {
...
export async function updateApp(body: API.AppUpdateDto, options?: { [key: string]: any }) {
